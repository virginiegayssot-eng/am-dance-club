...
- [ ] Dashboard tab bar not yet modernized to the pill style (only main/BYLA/demo have this so far) — still outstanding, wasn't part of this pass. Explicitly flagged by the user to not forget, whenever this branch (or `template`) gets its full pass.
