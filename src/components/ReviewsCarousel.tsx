...
export default function ReviewsCarousel() {
  ...
  return (
    <section className="bg-[#2041d8] text-white py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <p className="font-body text-xs uppercase tracking-[0.3em] text-[#e4c3cc] mb-2 text-center">What people say</p>
              ...
              <div className="flex gap-2">
                {reviews.map((_, i) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-colors ${i === index ? "bg-[#e4c3cc]" : "bg-white/20"}`}
                  />
                ))}
              </div>
