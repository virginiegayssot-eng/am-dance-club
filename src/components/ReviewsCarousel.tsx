...
export default function ReviewsCarousel() {
  ...
  return (
    <section className="bg-[#221f1c] text-white py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <p className="font-body text-xs uppercase tracking-[0.3em] text-[#ddd3c0] mb-2 text-center">What people say</p>
        <h2 className="font-heading text-3xl md:text-4xl mb-10 text-center">Loved by our community</h2>
              ...
              <div className="flex gap-2">
                {reviews.map((_, i) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-colors ${i === index ? "bg-[#ddd3c0]" : "bg-white/20"}`}
                  />
                ))}
              </div>
