    ...
    <footer className="bg-[#7d6653] text-white mt-auto">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <Image src="/logo.png" alt="Sable Studio" width={90} height={60} className="object-contain mb-4" />
            <p className="font-body text-sm text-white/70 leading-relaxed">
              Feel-good movement classes for every body.<br />
              Weekly classes
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-white/10 mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center gap-2">
          <p className="font-body text-xs text-white/40">
            © {new Date().getFullYear()} Sable Studio. All rights reserved.
          </p>
