    ...
    <body style="margin:0;padding:0;background:#f9f9f9;font-family:Arial,sans-serif;">
      <div style="max-width:560px;margin:40px auto;background:#ffffff;border-radius:16px;overflow:hidden;">
        ...
        <div style="padding:36px 32px;">
          <h2 style="color:#7d6653;font-size:22px;margin:0 0 16px;">You're booked, ${firstName}!</h2>
          ...
          <p style="text-align:center;margin:0 0 28px;">
            <a href="${process.env.NEXT_PUBLIC_APP_URL}/classes" style="background:#7d6653;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:50px;font-size:15px;font-weight:bold;display:inline-block;">Manage My Booking</a>
          </p>
