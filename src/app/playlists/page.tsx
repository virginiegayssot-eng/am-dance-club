  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 py-14 w-full">
        <div className="mb-10">
          <p className="font-body text-xs uppercase tracking-[0.3em] text-[#221f1c] mb-2">Members only</p>
          <h1 className="section-title mb-3">Class Playlists</h1>
          <p className="font-body text-gray-500">
            The music from our classes. Your weekly soundtrack starts here.
          </p>
        </div>

        {playlists.length === 0 ? (
          <div className="text-center py-20">
            <Music className="w-12 h-12 mx-auto mb-4 text-[#221f1c]" strokeWidth={1.5} />
