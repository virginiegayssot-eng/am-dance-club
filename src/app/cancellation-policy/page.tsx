    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 sm:px-6 py-14 w-full">
        ...
        <div className="space-y-8 font-body text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="font-heading text-lg text-[#7d6653] mb-3">Cancellations with 24+ hours notice</h2>
            <p>
              ...
              <a href="mailto:hello@sablestudio.au" className="text-[#7d6653] underline">hello@sablestudio.au</a> to arrange a refund.
            </p>
          </section>

          <section>
            <h2 className="font-heading text-lg text-[#7d6653] mb-3">Cancellations within 24 hours</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg text-[#7d6653] mb-3">No-shows</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg text-[#7d6653] mb-3">Emergency or illness</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg text-[#7d6653] mb-3">How to cancel</h2>
            <p>
              Log in to your account and visit your{" "}
              <Link href="/dashboard" className="text-[#7d6653] underline">Dashboard</Link> to cancel an upcoming booking directly.
