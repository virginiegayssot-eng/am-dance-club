                ...
                {upcomingBirthdays.map(s => {
                  ...
                  return (
                    <div key={s.id} className={`card p-5 ${isToday ? "ring-2 ring-[#334155] bg-[#94a3b8]/10" : isThisWeek ? "bg-[#e2e8f0]/10" : ""}`}>
                      ...
                      <Link href={`/chat?dm=${s.id}`} className="mt-3 font-body text-xs text-[#334155] hover:underline block">
          ...
          <div className="max-w-xl space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button type="button" onClick={selectAllInSegment} className="font-body text-xs text-[#334155] hover:underline">Select all</button>
              </div>
