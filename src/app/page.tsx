...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Hero */}
      <section className="bg-[#f0e8dd] py-24 md:py-36">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="max-w-2xl">
            <p className="font-body text-xs uppercase tracking-[0.3em] text-[#7d6653] mb-4">
              Weekly classes
            </p>
            <h1 className="font-heading text-5xl md:text-7xl leading-none mb-6">
              <span className="text-[#7d6653]">Sable Studio</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link href="/auth/login" className="font-body text-sm text-black/60 hover:text-[#7d6653] transition-colors self-center underline underline-offset-2">Already a member? Log in</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Blue info strip */}
      <section className="bg-[#7d6653] text-white py-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 md:gap-y-0 divide-y-0 md:divide-x md:divide-white/20">
            {[
              ...
              <div key={item.label} className="flex flex-col items-center text-center gap-1.5 px-4">
                <p className="font-heading text-xs uppercase tracking-widest text-[#f0e8dd]">{item.label}</p>
      ...
      <section className="bg-[#ddd0bd] py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <h2 className="font-heading text-3xl md:text-4xl mb-10 text-[#7d6653]">Why You'll Love Sable Studio</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={f.title} className="bg-white rounded-2xl p-6">
                <h3 className="font-heading text-lg text-[#7d6653] mb-2">{f.title}</h3>
      ...
      <section className="bg-[#7d6653] text-white py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              <h2 className="font-heading text-2xl uppercase tracking-wide mb-6 text-[#f0e8dd]">Location & Hours</h2>
      ...
      {/* CTA */}
      <section className="bg-[#f0e8dd] py-20">
