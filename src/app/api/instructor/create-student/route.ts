...
export async function POST(req: NextRequest) {
  ...
  const { error: emailError } = await resend.emails.send({
    ...
    to: email,
    subject: "You're invited to BYLA!",
    html: `
      <!DOCTYPE html>
      <html>
        ...
        <div style="max-width:560px;margin:40px auto;background:#ffffff;border-radius:16px;overflow:hidden;">
          ...
          <div style="padding:36px 32px;">
            ...
            <p style="color:#444;font-size:16px;line-height:1.6;margin:0 0 16px;">
              I'd love to have you join us at BYLA! Reggaeton classes for beginner to intermediate dancers, in Alexandria and Manly.
            </p>
            ...
            <div style="text-align:center;margin:32px 0;">
              <a href="${inviteUrl}" style="background:#000000;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:50px;font-size:15px;font-weight:bold;display:inline-block;">
                Set Up My Account
              </a>
            </div>
            <p style="color:#444;font-size:16px;line-height:1.6;margin:0 0 8px;">Can't wait to dance with you!</p>
  ...
  if (emailError) {
    ...
    // link so the instructor can send it manually rather than leaving the
