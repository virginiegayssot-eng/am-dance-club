    ...
    return (
      <div className="min-h-screen bg-[#fbf8f4] flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          <Mail className="w-14 h-14 mx-auto mb-6 text-[#221f1c]" strokeWidth={1.5} />
        ...
        <div className="card p-8">
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <label className="flex items-start gap-2.5 text-sm font-body text-gray-600">
              ...
              <span>
                I agree to the{" "}
                <Link href="/terms-and-conditions" target="_blank" className="text-[#221f1c] underline">
                  Terms &amp; Conditions
                </Link>
              </span>
            </label>
          ...
          <div className="mt-6 text-center">
            <p className="font-body text-sm text-gray-500">
              ...
              <Link href="/auth/login" className="text-[#221f1c] hover:underline">Sign in</Link>
            </p>
          </div>
        </div>
      </div>
