...
export const metadata = { title: "Class Filming & Photography Policy · [Studio Name]" };
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 sm:px-6 py-14 w-full">
        ...
        <div className="space-y-8 font-body text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="font-heading text-lg text-[#334155] mb-3">Filming and photography may occur</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg text-[#334155] mb-3">If you don't want to appear</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg text-[#334155] mb-3">Our commitment</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg text-[#334155] mb-3">Questions or concerns</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg text-[#334155] mb-3">By attending</h2>
            <p>
