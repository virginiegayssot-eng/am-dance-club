  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 py-14 w-full">
        <div className="mb-10">
          <p className="font-body text-xs uppercase tracking-[0.3em] text-[#2041d8] mb-2">Meet the team</p>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <GraduationCap className="w-10 h-10 text-[#2041d8] mx-auto mb-4" strokeWidth={1.5} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {instructors.map((inst) => (
              <div key={inst.id} className="card p-6">
                <div className="w-20 h-20 rounded-full bg-[#a3bdfe]/50 overflow-hidden flex items-center justify-center text-2xl font-heading mb-4">
                ...
                {inst.title && (
                  <p className="font-body text-xs uppercase tracking-widest text-[#2041d8] mb-3">{inst.title}</p>
                )}
                {inst.bio && (
