  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 sm:px-6 py-14 w-full">
        <p className="font-body text-xs uppercase tracking-[0.3em] text-[#221f1c] mb-2">Guide</p>
        <h1 className="section-title mb-10">How to Use the App</h1>

        <div className="space-y-8 font-body text-gray-700 leading-relaxed">

          <section>
            <h2 className="font-heading text-lg text-[#221f1c] mb-3">1. Create an account</h2>
            <p>
              Click <Link href="/auth/signup" className="text-[#221f1c] underline">Sign up</Link> and fill in your details.
              Once you're in, you'll land on your dashboard where you can book classes, manage passes, and more.
            </p>
          </section>

          <section>
            <h2 className="font-heading text-lg text-[#221f1c] mb-3">2. Book a class</h2>
            <p>
              Head to <Link href="/classes" className="text-[#221f1c] underline">Classes</Link> to see what's coming up.
          ...
          <section>
            <h2 className="font-heading text-lg text-[#221f1c] mb-3">3. Passes & pricing</h2>
            <p>
              Visit <Link href="/passes" className="text-[#221f1c] underline">Passes</Link> to see pricing options.
          ...
          <section>
            <h2 className="font-heading text-lg text-[#221f1c] mb-3">Need help?</h2>
            <p>
              Email us at{" "}
