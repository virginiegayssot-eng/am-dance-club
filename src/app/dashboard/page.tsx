        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md p-6">
            ...
            <p className="font-body text-sm mb-6">
              <Link href="/terms-and-conditions" target="_blank" className="text-[#000000] underline">Read the full Terms & Conditions</Link>
            </p>
            {filmingPolicyError && (
      ...
      <main className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 py-14 w-full">
        ...
        <div className="mb-10">
          ...
          <h1 className="section-title">
            Hola, {profile?.full_name?.split(" ")[0] ?? "dancer"}
          </h1>
        </div>
        ...
        {justBoughtPass && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl w-full max-w-sm p-6 text-center">
              <div className="w-14 h-14 rounded-full bg-[#9b7fc7]/20 flex items-center justify-center mx-auto mb-4">
                <Ticket className="w-7 h-7 text-[#000000]" strokeWidth={1.75} />
              </div>
              ...
              <p className="font-body text-sm text-gray-600 leading-relaxed mb-6">
                You're ready to book your first class. Head to Classes to reserve your spot.
              </p>
