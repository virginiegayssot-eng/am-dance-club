...
export const metadata = { title: "Terms & Conditions · THE A.M Dance Club" };
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 sm:px-6 py-14 w-full">
        ...
        <nav className="flex flex-wrap gap-x-6 gap-y-2 mb-12 pb-8 border-b border-gray-100">
          <a href="#cancellation" className="font-body text-sm text-[#2041d8] underline">Cancellation Policy</a>
          <a href="#privacy" className="font-body text-sm text-[#2041d8] underline">Privacy Policy</a>
          <a href="#filming" className="font-body text-sm text-[#2041d8] underline">Filming & Photography Policy</a>
          <a href="#safety" className="font-body text-sm text-[#2041d8] underline">Injury & Safety</a>
        </nav>

        <div className="space-y-16 font-body text-gray-700 leading-relaxed">

          <div id="cancellation">
            <h2 className="font-heading text-2xl text-[#2041d8] mb-6">Cancellation Policy</h2>
            <div className="space-y-8">

              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">Passes are non-refundable</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">Cancellations with 24+ hours notice</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">Cancellations within 24 hours</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">No-shows</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">Emergency or illness</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">How to cancel</h3>
                <p>
          ...
          <div id="privacy">
            <h2 className="font-heading text-2xl text-[#2041d8] mb-6">Privacy Policy</h2>
            <div className="space-y-8">
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">What information we collect</h3>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">How we use your information</h3>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">Data storage & security</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">Your rights</h3>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">Cookies</h3>
                <p>
          ...
          <div id="filming">
            <h2 className="font-heading text-2xl text-[#2041d8] mb-6">Filming & Photography Policy</h2>
            <div className="space-y-8">

              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">Filming and photography may occur</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">If you don't want to appear</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">Our commitment</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#2041d8] mb-3">Questions or concerns</h3>
                <p>
          ...
          <div id="safety">
            <h2 className="font-heading text-2xl text-[#2041d8] mb-6">Injury & Safety</h2>
            <div className="space-y-8">
