...
export const metadata = { title: "Terms & Conditions · Sable Studio" };
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 sm:px-6 py-14 w-full">
        ...
        <div className="space-y-16 font-body text-gray-700 leading-relaxed">
          ...
          <div id="cancellation">
            <h2 className="font-heading text-2xl text-[#221f1c] mb-6">Cancellation Policy</h2>
            <div className="space-y-8">

              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">Cancellations with 24+ hours notice</h3>
                <p>
                  ...
                  <a href="mailto:hello@sablestudio.au" className="text-[#221f1c] underline">hello@sablestudio.au</a> to arrange a refund.
                </p>
              </section>

              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">Cancellations within 24 hours</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">No-shows</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">Emergency or illness</h3>
                <p>
                  If you are unable to attend due to illness or emergency, please reach out to us as soon as possible at{" "}
                  <a href="mailto:hello@sablestudio.au" className="text-[#221f1c] underline">hello@sablestudio.au</a>.
                  We will do our best to accommodate you.
                </p>
              </section>

              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">How to cancel</h3>
                <p>
                  Log in to your account and visit your{" "}
                  <Link href="/dashboard" className="text-[#221f1c] underline">Dashboard</Link> to cancel an upcoming booking directly.
          ...
          <div id="privacy">
            <h2 className="font-heading text-2xl text-[#221f1c] mb-6">Privacy Policy</h2>
            <div className="space-y-8">

              <section>
                <p>
                  Sable Studio ("we", "us", "our") is committed to protecting your personal information in accordance with the
              ...
              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">What information we collect</h3>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">How we use your information</h3>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">Data storage & security</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">Your rights</h3>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">Cookies</h3>
                <p>
          ...
          <div id="filming">
            <h2 className="font-heading text-2xl text-[#221f1c] mb-6">Filming & Photography Policy</h2>
            <div className="space-y-8">

              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">Filming and photography may occur</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">If you don't want to appear</h3>
                <p>
              ...
              <section>
                <h3 className="font-heading text-lg text-[#221f1c] mb-3">Our commitment</h3>
                <p>
