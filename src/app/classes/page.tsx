    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 py-14 w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
          <div>
            <p className="font-body text-xs uppercase tracking-[0.3em] text-[#221f1c] mb-2">Book a class</p>
        ...
        {/* Active pass notice */}
        {hasPass && (
          <div className="bg-[#6b6259]/20 border border-[#6b6259] rounded-2xl p-4 mb-8">
            <div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <Clock className="w-12 h-12 mx-auto mb-4 text-[#221f1c]" strokeWidth={1.5} />
            ...
            {visibleClasses.map(cls => {
              ...
              return (
                <div key={cls.id} className="card flex flex-col">
                  <div className="relative bg-gradient-to-br from-[#f4efe6] to-[#6b6259] p-6">
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    {cls.is_special && (
                      <span className="inline-block bg-[#221f1c] text-white text-xs font-body font-bold uppercase tracking-wide px-3 py-1 rounded-full mb-3 self-start">
