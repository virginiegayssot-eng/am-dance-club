    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 py-14 w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
          <div>
            <p className="font-body text-xs uppercase tracking-[0.3em] text-[#7d6653] mb-2">Book a class</p>
            <h1 className="section-title mb-1">Upcoming Classes</h1>
            <p className="font-body text-gray-500">Weekly classes · Sydney, NSW</p>
          </div>
        ...
        {/* Active pass notice */}
        {hasPass && (
          <div className="bg-[#a89783]/20 border border-[#a89783] rounded-2xl p-4 mb-8">
            <div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <Clock className="w-12 h-12 mx-auto mb-4 text-[#7d6653]" strokeWidth={1.5} />
            ...
            {visibleClasses.map(cls => {
              ...
              return (
                <div key={cls.id} className="card flex flex-col">
                  <div className="relative bg-gradient-to-br from-[#f0e8dd] to-[#a89783] p-6">
                    {cls.is_special && (
                      <span className="absolute top-4 right-4 bg-[#7d6653] text-white text-xs font-body font-bold uppercase tracking-wide px-3 py-1 rounded-full">
                        {cls.special_label || "Special Class"}
                      </span>
                    )}
                    <p className="font-body text-xs uppercase tracking-widest text-[#7d6653] mb-1">
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    <div className="space-y-1.5 mb-5">
                      <div className="flex items-center gap-2 text-sm font-body text-gray-600"><Clock className="w-4 h-4 text-[#7d6653]" strokeWidth={1.5} />{formatTime(cls.class_time)} · {cls.duration_minutes} min</div>
                      <div className="flex items-center gap-2 text-sm font-body text-gray-600"><MapPin className="w-4 h-4 text-[#7d6653]" strokeWidth={1.5} />{cls.location}</div>
                      {isFull && (
