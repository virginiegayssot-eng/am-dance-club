  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 py-14 w-full">
        <div className="mb-10">
          <p className="font-body text-xs uppercase tracking-[0.3em] text-[#221f1c] mb-2">Watch anytime</p>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <Film className="w-12 h-12 mx-auto mb-4 text-[#221f1c]" strokeWidth={1.5} />
                    ...
                    playing === v.id ? (
                      ...
                      >
                        ...
                        <div className="w-14 h-14 bg-white/90 group-hover:bg-white rounded-full flex items-center justify-center shadow-lg transition-all group-hover:scale-110">
                          <div className="w-0 h-0 border-t-[9px] border-t-transparent border-b-[9px] border-b-transparent border-l-[16px] border-l-[#221f1c] ml-1" />
                        </div>
                      </button>
                    )
                  ) : playing === v.id ? (
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {v.video_type === "r2" ? (
                      <button
                        ...
                        className="font-body text-xs text-[#221f1c] hover:underline flex items-center gap-1 disabled:opacity-50"
                      >
