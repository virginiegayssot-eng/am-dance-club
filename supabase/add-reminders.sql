...
-- Run add-admin-flag.sql FIRST (this references is_admin). Then run this,
-- then edit and run the cron.schedule block at the bottom (it needs your
-- real app URL and CRON_SECRET filled in).
